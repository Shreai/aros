...
export const workspaceApi = {
  ...
  addMember: (auth: WorkspaceAuth, email: string, role: string) => request<WorkspaceMember & { invited?: boolean }>(auth, `/workspaces/${encodeURIComponent(auth.workspaceId)}/members`, { method: 'POST', body: JSON.stringify({ email, role }) }),
